    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                <!-- Forget Password OTP-->
                <form action="{{ route('match.otp') }}" method="POST">
                    <div class="login-form">
                        <h4>Please check your email and get OTP code to input this.</h4>
                        <div class="row">
                            @csrf
                            <div class="col-md-12 col-12 mb-20">
                                <label>OTP Code</label>
                                <input class="mb-0" type="text" placeholder="OTP Code" name="otp_code">
                                @error('otp_code')
